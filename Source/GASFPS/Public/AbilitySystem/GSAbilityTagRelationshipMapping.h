...
#include "GSAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FGSAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class GASFPS_API UGSAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FGSAbilityTagRelationship> AbilityTagRelationships;
