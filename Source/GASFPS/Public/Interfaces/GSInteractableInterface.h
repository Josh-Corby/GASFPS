...
#include "GSInteractableInterface.generated.h"

// This class does not need to be modified.
UINTERFACE(MinimalAPI)
class UGSInteractableInterface : public UInterface
{
	GENERATED_BODY()
};
 ...
 * 
 */
class GASFPS_API IGSInteractableInterface
{
	GENERATED_BODY()
...
public:
	...
	*/
	...
	bool IsAvailableForInteraction(AActor* InteractionActor) const;
	virtual bool IsAvailableForInteraction_Implementation(AActor* InteractionActor) const;
	...
	*/
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "Interactable")
	float GetInteractionDuration(AActor* InteractionActor) const;
	virtual float GetInteractionDuration_Implementation(AActor* InteractionActor) const;
	...
	*/
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "Interactable")
	void GetPreInteractSyncType(bool& bShouldSync, EAbilityTaskNetSyncType& Type, AActor* InteractionActor) const;
	virtual void GetPreInteractSyncType_Implementation(bool& bShouldSync, EAbilityTaskNetSyncType& Type, AActor* InteractionActor) const;
	...
	*/
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "Interactable")
	void GetPostInteractSyncType(bool& bShouldSync, EAbilityTaskNetSyncType& Type, AActor* InteractionActor) const;
	void GetPostInteractSyncType_Implementation(bool& bShouldSync, EAbilityTaskNetSyncType& Type, AActor* InteractionActor) const;
	...
	*/
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "Interactable")
	void PreInteract(AActor* InteractingActor, AActor* InteractionActor);
	virtual void PreInteract_Implementation(AActor* InteractingActor, AActor* InteractionActor) {};
	...
	*/
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "Interactable")
	void PostInteract(AActor* InteractingActor, AActor* InteractionActor);
	virtual void PostInteract_Implementation(AActor* InteractingActor, AActor* InteractionActor) {};
	...
	*/
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "Interactable")
	void CancelInteraction(AActor* InteractionActor);
	virtual void CancelInteraction_Implementation(AActor* InteractionActor) {};
	...
	* @param InteractionComponent UPrimitiveComponent in case an Actor has many separate interactable areas.
	*/
	virtual FSimpleMulticastDelegate* GetTargetCancelInteractionDelegate(AActor* InteractionActor);
	...
	*/
	...
	void RegisterInteracter(AActor* InteractionActor, AActor* InteractingActor);
	void RegisterInteracter_Implementation(AActor* InteractionActor, AActor* InteractingActor);

	/**
	* Unregisters an interacting Actor from this Interactable. Not meant to be overriden.
	*/
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "Interactable|Do Not Override")
	void UnregisterInteracter(AActor* InteractionActor, AActor* InteractingActor);
	void UnregisterInteracter_Implementation(AActor* InteractionActor, AActor* InteractingActor);
	...
	*/
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "Interactable|Do Not Override")
	void InteractableCancelInteraction(AActor* InteractionActor);
	void InteractableCancelInteraction_Implementation(AActor* InteractionActor);

protected:
	TMap<AActor*, TArray<AActor*>> Interacters;
};
